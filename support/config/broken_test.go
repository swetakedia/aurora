...
func TestOptionalBlocksafeFields(t *testing.T) {
	var val struct {
		F1 string `valid:"blocksafe_accountid,optional"`
		F2 string `valid:"optional,blocksafe_accountid"`
		F3 string `valid:"blocksafe_seed,optional"`
		F4 string `valid:"optional,blocksafe_accountid"`
	}
