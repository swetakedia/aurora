...
func TestAccountIDValidator(t *testing.T) {
	var val struct {
		Empty        string `valid:"blocksafe_accountid"`
		NotSTRKey    string `valid:"blocksafe_accountid"`
		NotAccountID string `valid:"blocksafe_accountid"`
		Valid        string `valid:"blocksafe_accountid"`
		WrongType    int    `valid:"blocksafe_accountid"`
	}
...
func TestSeedValidator(t *testing.T) {
	var val struct {
		Empty     string `valid:"blocksafe_seed"`
		NotSTRKey string `valid:"blocksafe_seed"`
		NotSeed   string `valid:"blocksafe_seed"`
		Valid     string `valid:"blocksafe_seed"`
		WrongType int    `valid:"blocksafe_seed"`
	}
