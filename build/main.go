...
// structures used by the blocksafe network, most importanly transactions.
//
...
var (
	...
	// to the main public blocksafe network.
	...
	// to the test blocksafe network (often called testnet).
	TestNetwork = Network{network.TestNetworkPassphrase}

	// DefaultNetwork is a mutator that configures the
	// transaction for submission to the default blocksafe
...
// Network establishes the blocksafe network that a transaction should apply to.
