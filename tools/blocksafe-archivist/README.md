...
This is a small tool, written in Go, for working with `blocksafe-core` history archives directly.
It is a standalone tool that does not require `blocksafe-core`, or any other programs.

It is much smaller and simpler than `blocksafe-core`, and is intended only for archive-maintenance tasks.
...
```
$ go install github.com/blocksafe/go/tools/blocksafe-archivist
```

## Usage

```
inspect blocksafe history archive

Usage:
  blocksafe-archivist [flags]
  blocksafe-archivist [command]
...
Flags:
  ...
  -h, --help              help for blocksafe-archivist
...
Use "blocksafe-archivist [command] --help" for more information about a command.
```

## Specifying history archives

Unlike `blocksafe-core`, `blocksafe-archivist` does not run subprocesses to access history archives;
...
`blocksafe-archivist` supports reading from and writing to any S3-compatible storage.
...
```
$ blocksafe-archivist status --s3endpoint ams3.digitaloceanspaces.com s3://bucketname/prefix
```
...
```
$ blocksafe-archivist status http://s3-eu-west-1.amazonaws.com/history.blocksafe.org/prd/core-testnet/core_testnet_001

       Archive: http://s3-eu-west-1.amazonaws.com/history.blocksafe.org/prd/core-testnet/core_testnet_001
...
```
$ blocksafe-archivist mirror http://s3-eu-west-1.amazonaws.com/history.blocksafe.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 18:27:09 mirroring http://s3-eu-west-1.amazonaws.com/history.blocksafe.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ blocksafe-archivist --last 1024 mirror http://s3-eu-west-1.amazonaws.com/history.blocksafe.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 19:14:01 mirroring http://s3-eu-west-1.amazonaws.com/history.blocksafe.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ blocksafe-archivist scan file://local-archive
...
```
$ blocksafe-archivist --last 4096 scan file://local-archive
...
$ blocksafe-archivist --low 1000000 --high 1006000 scan file://local-archive
...
```
$ blocksafe-archivist --verify --last 4096 scan file://local-archive
...
$ blocksafe-archivist repair file://local-archive file://broken-archive
...
```
 blocksafe-archivist dumpxdr local-archive/transactions//00/20/de/transactions-0020de7f.xdr.gz
