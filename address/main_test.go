...
func TestNew(t *testing.T) {
	cases := []struct {
		...
		{"scott", "blocksafe.org", "scott*blocksafe.org"},
		{"", "blocksafe.org", "*blocksafe.org"},
		{"scott", "", "scott*"},
	}
...
func TestSplit(t *testing.T) {
	cases := []struct {
		...
		{"happy path", "scott*blocksafe.org", "scott", "blocksafe.org", nil},
		{"blank", "", "", "", ErrInvalidAddress},
		{"blank name", "*blocksafe.org", "", "", ErrInvalidName},
