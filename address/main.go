// Package address provides utility functions for working with blocksafe
// addresses. See https://www.blocksafe.org/developers/guides/concepts/federation.
// html#blocksafe-addresses for more on addresses.
package address
