// Package federation provides a pluggable handler that satisfies the Blocksafe
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided blocksafe address.
...
// conform to the Blocksafe federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// blocksafe account id to lookup, such as
