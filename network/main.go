// Package network contains functions that deal with blocksafe network passphrases
// and IDs.
package network
...
import (
	...
	"github.com/blocksafe/go/hash"
	"github.com/blocksafe/go/support/errors"
	"github.com/blocksafe/go/xdr"
)

const (
	// PublicNetworkPassphrase is the pass phrase used for every transaction intended for the public blocksafe network
	PublicNetworkPassphrase = "Public Global Blocksafe Network ; September 2015"
...
// resulting hash is the value that can be signed by blocksafe secret key to
// authorize the transaction identified by the hash to blocksafe validators.
