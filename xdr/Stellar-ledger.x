// Copyright 2015 Blocksafe Development Foundation and contributors. Licensed
// under the Apache License, Version 2.0. See the COPYING file at the root
// of this distribution or at http://www.apache.org/licenses/LICENSE-2.0

%#include "xdr/Blocksafe-SCP.h"
%#include "xdr/Blocksafe-transaction.h"
...
/* BlocksafeValue is the value used by SCP to reach consensus on a given ledger
*/
...
/* Ledger upgrades
note that the `upgrades` field from BlocksafeValue is normalized such that
