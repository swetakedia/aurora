...
type SendRequest struct {
	...
	// Source account ID
	Source string `form:"source" valid:"required,blocksafe_accountid"`
	// Sender address (like alice*blocksafe.org)
	Sender string `form:"sender" valid:"required,blocksafe_address"`
	// Destination address (like bob*blocksafe.org)
	Destination string `form:"destination" valid:"required,blocksafe_address"`
	// ForwardDestination
