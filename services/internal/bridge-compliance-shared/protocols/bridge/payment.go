...
import (
	...
	"github.com/blocksafe/go/services/internal/bridge-compliance-shared/http/helpers"
	"github.com/blocksafe/go/services/internal/bridge-compliance-shared/protocols"
	complianceServer "github.com/blocksafe/go/services/internal/bridge-compliance-shared/protocols/compliance"
...
var (
	...
	PaymentCannotResolveDestination = &helpers.ErrorResponse{Code: "cannot_resolve_destination", Message: "Cannot resolve federated Blocksafe address.", Status: http.StatusBadRequest}
...
type PaymentRequest struct {
	...
	Source string `form:"source" valid:"optional,blocksafe_seed"`
	// Sender address (like alice*blocksafe.org)
	Sender string `form:"sender" valid:"optional,blocksafe_address"`
	// Destination address (like bob*blocksafe.org)
	Destination string `form:"destination" valid:"optional,blocksafe_destination"`
	// ForwardDestination
	...
	Amount string `form:"amount" valid:"required,blocksafe_amount"`
	// Code of the asset destination should receive
	AssetCode string `form:"asset_code" valid:"optional,blocksafe_asset_code"`
	// Issuer of the asset destination should receive
	AssetIssuer string `form:"asset_issuer" valid:"optional,blocksafe_accountid"`
	// Only for path_payment
	SendMax string `form:"send_max" valid:"optional,blocksafe_amount"`
	// Only for path_payment
	SendAssetCode string `form:"send_asset_code" valid:"optional,blocksafe_asset_code"`
	// Only for path_payment
	SendAssetIssuer string `form:"send_asset_issuer" valid:"optional,blocksafe_accountid"`
