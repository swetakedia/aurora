...
psql federation_sample -e <<-EOS
  ...
  INSERT INTO people (id, name, domain) VALUES 
    ('GD2GJPL3UOK5LX7TWXOACK2ZPWPFSLBNKL3GTGH6BLBNISK4BGWMFBBG', 'bob', 'blocksafe.org'),
    ('GCYMGWPZ6NC2U7SO6SMXOP5ZLXOEC5SYPKITDMVEONLCHFSCCQR2J4S3', 'alice', 'blocksafe.org');
EOS