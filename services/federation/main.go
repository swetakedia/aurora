...
import (
	...
	"github.com/blocksafe/go/handlers/federation"
	"github.com/blocksafe/go/support/app"
	"github.com/blocksafe/go/support/config"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "federation",
		Short: "blocksafe federation server",
		Long: `
The blocksafe federation server let's you easily integrate the blocksafe federation
