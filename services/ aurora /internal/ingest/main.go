...
// data produced by the connected blocksafe-core database, transforms it and
...
// Cursor iterates through a blocksafe core database's ledgers
type Cursor struct {
	...
	// CoreDB is the blocksafe-core db that data is ingested from.
	CoreDB *db.Session
...
type System struct {
	...
	Network string
	// BlocksafeCoreURL is the http endpoint of the blocksafe-core that data is being
	// ingested from.
	BlocksafeCoreURL string
...
// New initializes the ingester, causing it to begin polling the blocksafe-core
...
func NewSession(i *System) *Session {
	...
	return &Session{
		...
		Network:          i.Network,
		BlocksafeCoreURL:   i.BlocksafeCoreURL,
