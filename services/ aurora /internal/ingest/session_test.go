...
import (
	...
	protocolEffects "github.com/blocksafe/go/protocols/aurora/effects"
...
func Test_ingestSignerEffects(t *testing.T) {
	...
	// Regression: https://github.com/blocksafe/aurora/issues/390 doesn't produce a signer effect when
