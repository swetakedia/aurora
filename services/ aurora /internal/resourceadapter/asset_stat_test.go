...
import (
	...
	protocol "github.com/blocksafe/go/protocols/aurora"
...
func TestLargeAmount(t *testing.T) {
	row := assets.AssetStatsR{
		...
		NumAccounts: 429,
		Flags:       0,
		Toml:        "https://xim.com/.well-known/blocksafe.toml",
	}
	...
	assert.Equal(t, "https://xim.com/.well-known/blocksafe.toml", res.Links.Toml.Href)
}
