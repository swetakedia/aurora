...
// be submitted to the backing blocksafe-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to blocksafe-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to blocksafe-core
