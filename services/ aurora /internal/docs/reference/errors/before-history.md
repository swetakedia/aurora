...
$ curl -X GET "https://aurora-testnet.blocksafe.org/transactions?cursor=1&order=desc"
{
  ...
  "status": 410,
  "detail": "This aurora instance is configured to only track a portion of the blocksafe network's latest history. This request is asking for results prior to the recorded history known to this aurora instance.",
