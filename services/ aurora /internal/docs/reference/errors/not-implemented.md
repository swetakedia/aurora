...
```shell
$ curl -X GET "https://aurora-testnet.blocksafe.org/ledgers/200/effects"
{
  ...
  "instance": "aurora-testnet-001.prd.blocksafe001.internal.blocksafe-ops.com/hCYL7oezXs-141917"
}
```
