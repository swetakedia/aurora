...
clientData:
  laboratoryUrl: https://www.blocksafe.org/laboratory/#explorer?resource=transactions&endpoint=for_ledger
---
...
```sh
curl "https://aurora-testnet.blocksafe.org/ledgers/69859/transactions"
```
