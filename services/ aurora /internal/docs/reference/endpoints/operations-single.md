...
clientData:
  laboratoryUrl: https://www.blocksafe.org/laboratory/#explorer?resource=operations&endpoint=single
---
...
```sh
curl https://aurora-testnet.blocksafe.org/operations/77309415424
```
