...
clientData:
  laboratoryUrl: https://www.blocksafe.org/laboratory/#explorer?resource=transactions&endpoint=all
---
...
This endpoint can also be used in [streaming](../streaming.md) mode. This makes it possible to use it to listen for new transactions as they get made in the Blocksafe network.
...
curl "https://aurora-testnet.blocksafe.org/transactions?limit=200&order=desc"
```
