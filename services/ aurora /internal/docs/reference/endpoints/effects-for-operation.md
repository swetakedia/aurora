...
clientData:
  laboratoryUrl: https://www.blocksafe.org/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://aurora-testnet.blocksafe.org/operations/77309415424/effects"
```
