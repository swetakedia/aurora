...
clientData:
  laboratoryUrl: https://www.blocksafe.org/laboratory/#explorer?resource=effects&endpoint=for_ledger
---
...
```sh
curl "https://aurora-testnet.blocksafe.org/ledgers/69859/effects"
```
