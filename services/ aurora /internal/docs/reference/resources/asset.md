...
**Assets** are the units that are traded on the Blocksafe Network.

An asset consists of an type, code, and issuer.

To learn more about the concept of assets in the Blocksafe network, take a look at the [Blocksafe assets concept guide](https://www.blocksafe.org/developers/guides/concepts/assets.html).
...
|--------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------
| toml  | `https://www.blocksafe.org/.well-known/blocksafe.toml`| Link to the TOML file for this issuer |
...
```json
{
  "_links": {
    "toml": {
      "href": "https://www.blocksafe.org/.well-known/blocksafe.toml"
    }
  },
