...
import (
	...
	. "github.com/blocksafe/go/services/aurora/internal/db2/history"
	. "github.com/blocksafe/go/services/aurora/internal/test/trades"
...
func TestTradeActions_IndexRegressions(t *testing.T) {
	t.Run("Regression:  https://github.com/blocksafe/go/services/aurora/internal/issues/318", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
	...
	t.Run("Regression for nil prices: https://github.com/blocksafe/go/issues/357", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
...
// https://github.com/blocksafe/go/issues/215
