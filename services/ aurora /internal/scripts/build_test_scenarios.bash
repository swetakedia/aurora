...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/blocksafe/go/services/aurora/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
#PACKAGES=$(find $GOTOP/src/github.com/blocksafe/go/services/aurora/internal/test/scenarios -iname 'failed_transactions.rb')

go install github.com/blocksafe/go/services/aurora

dropdb hayashi_scenarios --if-exists
createdb hayashi_scenarios

export BLOCKSAFE_CORE_DATABASE_URL="postgres://localhost/hayashi_scenarios?sslmode=disable"
export DATABASE_URL="postgres://localhost/aurora_scenarios?sslmode=disable"
export NETWORK_PASSPHRASE="Test SDF Network ; September 2015"
export BLOCKSAFE_CORE_URL="http://localhost:8080"
...
for i in $PACKAGES; do
  ...
  psql $BLOCKSAFE_CORE_DATABASE_URL < $CORE_SQL
...
go generate github.com/blocksafe/go/services/aurora/internal/test/scenarios
# go test github.com/blocksafe/go/services/aurora/internal/ingest
