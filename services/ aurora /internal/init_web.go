...
// initWebMiddleware installs the middleware stack used for aurora onto the
// provided app.
...
// initWebActions installs the routing configuration of aurora onto the
...
func initWebActions(app *App) {
	...
	// Deprecated - remove in: aurora-v0.18.0
