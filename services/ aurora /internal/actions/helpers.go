...
import (
	...
	"github.com/blocksafe/go/support/time"
...
// GetAddress retrieves a blocksafe address.  It confirms the value loaded is a
// valid blocksafe address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a blocksafe
...
// the string at the provided name in accordance with the blocksafe client
// conventions
