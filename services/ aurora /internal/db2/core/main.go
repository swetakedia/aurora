...
// reading rows from a Blocksafe Core db
package core
...
// Offer is row of data from the `offers` table from blocksafe-core
type Offer struct {
...
// Q is a helper struct on which to hang common queries against a blocksafe
// core database.
type Q struct {
	*db.Session
}
...
// Signer is a row of data from the `signers` table from blocksafe-core
type Signer struct {
	Accountid string
	Publickey string
	Weight    int32
...
// Transaction is row of data from the `txhistory` table from blocksafe-core
...
// TransactionFee is row of data from the `txfeehistory` table from blocksafe-core
...
// Trustline is a row of data from the `trustlines` table from blocksafe-core
...
// blocksafe-core database this ingestion system is communicating with.  Aurora,
