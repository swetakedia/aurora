...
func initDbMetrics(app *App) {
	...
	app.metrics.Register("blocksafe_core.latest_ledger", app.coreLatestLedgerGauge)
	app.metrics.Register("history.open_connections", app.auroraConnGauge)
	app.metrics.Register("blocksafe_core.open_connections", app.coreConnGauge)
...
func init() {
	...
	appInit.Add("db-metrics", initDbMetrics, "metrics", "aurora-db", "core-db")
