...
import (
	...
	"github.com/blocksafe/go/services/aurora/internal/hchi"
...
var (
	...
	BeforeHistory = problem.P{
		...
		Detail: "This aurora instance is configured to only track a " +
			"portion of the blocksafe network's latest history. This request " +
	...
	StaleHistory = problem.P{
		...
		Detail: "This aurora instance is configured to reject client requests " +
			...
			"behind the connected instance of blocksafe-core.  If you operate this " +
