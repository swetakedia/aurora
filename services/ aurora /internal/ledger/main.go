// Package ledger provides useful utilities concerning ledgers within blocksafe,
// specifically as a central location to store a cached snapshot of the state of
// both aurora's and blocksafe-core's views of the ledger.  This package is
...
// State represents a snapshot of both aurora's and blocksafe-core's view of the
// ledger.
type State struct {
