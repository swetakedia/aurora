...
CREATE TABLE address_association (
  ...
  blocksafe_public_key varchar(56) NOT NULL UNIQUE,
  created_at timestamp NOT NULL,
  PRIMARY KEY (chain, address_index, address, blocksafe_public_key),
...
CREATE TABLE transactions_queue (
  ...
  /* ethereum: 100000000 in year 2128 + 7 decimal precision in Blocksafe + dot */
  /* bitcoin:   21000000              + 7 decimal precision in Blocksafe + dot */
  amount varchar(20) NOT NULL,
  blocksafe_public_key varchar(56) NOT NULL,
  ...
  CONSTRAINT valid_blocksafe_public_key CHECK (char_length(blocksafe_public_key) = 56)
);
