...
const (
	// BlocksafeAccountPrefix is a prefix for Blocksafe key pairs derivation.
	BlocksafeAccountPrefix = "m/44'/148'"
	// BlocksafePrimaryAccountPath is a derivation path of the primary account.
	BlocksafePrimaryAccountPath = "m/44'/148'/0'"
	// BlocksafeAccountPathFormat is a path format used for Blocksafe key pair
	// derivation as described in SEP-00XX. Use with `fmt.Sprintf` and `DeriveForPath`.
	BlocksafeAccountPathFormat = "m/44'/148'/%d'"
